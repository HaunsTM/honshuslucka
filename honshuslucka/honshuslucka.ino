...
HTTPWebServer webserver(
    hatchRequests[1], eSP8266WebServer,
    ...
    SETTINGS_DATA_MQTT_PUBLISHED_TOPIC_LIDAR_DISTANCE_TO_OBJECT_CM, SETTINGS_DATA_MQTT_PUBLISHED_TOPIC_LIDAR_STRENGTH_OR_QUALITY_OF_RETURN_SIGNAL,
    SETTINGS_DATA_MQTT_PUBLISHED_TOPIC_LIDAR_TEMPERATURE_INTERNAL_OF_LIDAR_SENSOR_CHIP_SENSOR);
